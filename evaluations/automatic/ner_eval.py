...
def calculate_precision_recall_f1(gs, df_tool, id_col, ent_col):
    """
    ...
    for index, gs_row in gs.iterrows():
        ...
        tool_entities = [entity.upper() for entity in df_tool.loc[df_tool[id_col] == gs_id, ent_col].tolist()]
...
def eval(dataset_path, gs_path, id_col, ent_col):
    ...
    precision, recall, f1_score = calculate_precision_recall_f1(gs, df_tool, id_col, ent_col)
